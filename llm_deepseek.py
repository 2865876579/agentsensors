    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "   - \"升高/调高/高点\" → target_kpa=current_kpa+0.8 (0-6范围内)\n"
                "   - \"降低/放低/低点\" → target_kpa=current_kpa-0.8\n"
                "   - \"放完/排空/全放\" → target_kpa=0.5, action=recover\n"
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "target_kpa": {
                        "type": "number", "minimum": 0.5, "maximum": 12.0,
...
async def _dispatch_tool(name: str, arguments: dict, *, client_id: str = "", turn_id: int = 0) -> str:
    ...
    if name == "web_search":
        ...
        target_kpa = arguments.get("target_kpa", 0)
